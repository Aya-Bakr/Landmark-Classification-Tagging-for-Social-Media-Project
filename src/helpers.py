...
def setup_env():
    ...
    print("GPU available" if use_cuda else "GPU *NOT* available. Will use CPU (slow)")
...
def download_and_extract(url="https://udacity-dlnfd.s3-us-west-1.amazonaws.com/datasets/landmark_images.zip"):
    try:
        ...
        print(f"Dataset already downloaded. If you need to re-download, please delete the directory {location}")
        return None
